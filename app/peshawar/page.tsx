			...
			<section className="relative w-full h-screen min-h-[600px] overflow-hidden pt-[100px] sm:pt-[104px]" style={{ backgroundColor: secondaryBlack }}>
				...
				<div className="relative z-10 h-full flex items-center justify-center">
					<div className="text-center px-4">
						...
						Walk through the 2,000 year old Qissa Khwani Bazaar and admire the architectural beauty of the Mahabat Khan Mosque in the heart of the City of Flowers. </p>						<button
