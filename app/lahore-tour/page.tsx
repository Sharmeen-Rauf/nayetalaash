	...
	return (
		<div className="relative min-h-screen font-sans overflow-x-hidden">
			...
			<section 
				...
				className={`py-8 md:py-12 bg-gray-50 relative overflow-x-hidden scroll-reveal-fade-up ${visibleSections.has('guided-lahore-tour-packages') ? 'revealed' : ''}`}
			>
				<div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
					{/* Main Title */}
					<div className="text-center mb-10">
						<h2 className="text-2xl md:text-3xl lg:text-4xl font-bold" style={{ color: secondaryBlack }}>
							Guided Lahore Tour Packages / Lahore City Tour
						</h2>
					</div>
						...
						<div className="lg:col-span-4">
							<div className="bg-white rounded-lg shadow-md p-2">
								{[
									...
									>
										<p className="leading-normal text-left" style={{ color: `${secondaryBlack}90`, fontSize: '16px', lineHeight: '1.5' }}>
