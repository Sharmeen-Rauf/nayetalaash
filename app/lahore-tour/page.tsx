			...
			<section className="relative w-full h-screen min-h-[600px] overflow-hidden pt-[100px] sm:pt-[104px]" style={{ backgroundColor: secondaryBlack }}>
				...
				<div className="relative z-10 h-full flex items-center justify-center">
					<div className="text-center px-4">
						...
						Walk through the 1,000 year old gates of the Walled City and feel the energy of Wagah Border your journey into the heart of Punjab begins here </p>						<div className="mt-8">
							<button 
					...
					<div className="space-y-6">
						{[
							...
							>
								...
								>
									<div className="relative h-40 lg:h-64 w-full max-w-full lg:max-w-full mx-auto overflow-hidden rounded-lg">
										<Image
					...
					<div className="max-w-4xl mx-auto">
						...
						<div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
							...
							<div className="lg:col-span-1">
								<div className="relative h-40 lg:h-64 w-full rounded-lg overflow-hidden">
									<Image 
