		...
		<div className="relative min-h-screen font-sans overflow-x-hidden">
			...
			<section className="relative w-full h-screen min-h-[600px] overflow-hidden pt-[100px] sm:pt-[104px]" style={{ backgroundColor: secondaryBlack }}>
				...
				<div 
					...
					style={{ 
						backgroundImage: "url('/images/Chitral District-banner.jpg')",
				...
				<div className="relative z-10 h-full flex items-center justify-center">
					<div className="text-center px-4">
						...
						<p className="text-base sm:text-sm md:text-lg text-white font-medium max-w-2xl mx-auto leading-relaxed hero-text-reveal hero-text-delay-2 mb-6">
							Discover the unique heritage of the Kalash people and witness the world famous Shandur Polo Festival under the gaze of the Hindu Kush's highest peak.
						</p>
						<button
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
						...
						<div className="order-2 lg:order-1">
							<h2 className="text-2xl md:text-3xl font-bold mb-4" style={{ color: secondaryBlack }}>
								Places To Visit In Chitral Tour
							</h2>
							<p className="text-sm md:text-base leading-relaxed mb-6" style={{ color: `${secondaryBlack}90`, lineHeight: '1.6' }}>
								Chitral District, often called the "Land of the Living Cultures," is a historically rich and geographically diverse region nestled in the mighty Hindu Kush mountain range. It is towered over by the majestic Tirich Mir (the highest peak of the Hindu Kush) and is globally famous for its three Kalash Valleys, home to a unique and ancient non-Muslim minority community. Chitral offers an exceptional blend of cultural tourism and high-altitude adventure. From the thrill of the Shandur Polo Festival on the world's highest polo ground to the therapeutic waters of Garam Chashma, the district is a destination where history and nature converge.
							</p>
							<button
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
					<div className="text-center mb-8">
						<h2 className="text-2xl md:text-3xl font-bold mb-6" style={{ color: secondaryBlack }}>
							Must Experience When in <span style={{ borderBottom: `2px solid ${primaryOrange}`, display: 'inline-block', paddingBottom: '2px' }}>Chitral District</span>
						</h2>
					</div>
