		...
		<div className="relative min-h-screen font-sans overflow-x-hidden">
			...
			<section className="relative w-full h-screen min-h-[600px] overflow-hidden pt-[100px] sm:pt-[104px]" style={{ backgroundColor: secondaryBlack }}>
				...
				<div 
					...
					style={{ 
						backgroundImage: "url('/images/Skardu & Kharmang-banner.jpg')",
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
					<div className="text-center mb-8">
						<h2 className="text-2xl md:text-3xl font-bold mb-6" style={{ color: secondaryBlack }}>
							Must Experience When in <span style={{ borderBottom: `2px solid ${primaryOrange}`, display: 'inline-block', paddingBottom: '2px' }}>Skardu Kharmang District</span>
						</h2>
					</div>
			...
			>
				<div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl relative z-10">
					...
					<div className="space-y-0">
						{[
							{
								question: 'Where is Skardu Kharmang District located?',
...
export default SkarduKharmangPage;
