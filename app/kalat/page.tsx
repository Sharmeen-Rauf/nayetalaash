		...
		<div className="relative min-h-screen font-sans overflow-x-hidden">
			...
			<section className="relative w-full h-screen min-h-[600px] overflow-hidden pt-[100px] sm:pt-[104px]" style={{ backgroundColor: secondaryBlack }}>
				...
				<div 
					...
					style={{ 
						backgroundImage: "url('/images/Kalat-banner.jpg')",
				...
				<div className="relative z-10 h-full flex items-center justify-center">
					<div className="text-center px-4">
						...
						Journey to the historic capital of the Khans from Harboi’s high peaks to the mysterious Pandran caves in the Brahui heartland.						</p>
						<button
