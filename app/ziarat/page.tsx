		...
		<div className="relative min-h-screen font-sans overflow-x-hidden">
			...
			<section className="relative w-full h-screen min-h-[600px] overflow-hidden pt-[100px] sm:pt-[104px]" style={{ backgroundColor: secondaryBlack }}>
				...
				<div 
					...
					style={{ 
						backgroundImage: "url('/images/Ziarat-banner.jpg')",
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
						...
						<div className="order-2 lg:order-1">
							...
							<p className="text-sm md:text-base leading-relaxed mb-6" style={{ color: `${secondaryBlack}90`, lineHeight: '1.6' }}>
								Ziarat District, often called the "Sanatorium of the Frontier," is a breathtaking high altitude hill station in Balochistan, situated around 2,450 meters (8,000 feet) above sea level. Famous for its cool climate and emerald landscapes, it is home to one of the world's oldest and largest juniper forests, where some trees are believed to be over 5,000 years old. Surrounded by rugged limestone cliffs, rolling hills, and lush apple and cherry orchards, Ziarat offers a refreshing escape from the heat of the plains. The district also holds great historical importance for Pakistan, as Quaid-e-Azam Muhammad Ali Jinnah spent his final days here. In autumn, the valley becomes especially enchanting, filled with the fragrance of ripening fruit and golden foliage. Whether you seek peaceful moments among ancient "living fossils" or adventure in the Khalifat Hills, Ziarat is a place of natural beauty, tranquility, and national pride.
							</p>
							<button
